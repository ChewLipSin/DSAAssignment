...
/**
 * DoublyLinkedList.java - A class that implements the ADT linked list using a
 * doubly linked structure.
 *
 * @author Chew Lip Sin
 * @param <T> The type of elements stored in the linked list.
 */
public class DoublyLinkedList<T> implements LinkedListInterface<T>, Serializable {
    ...
    public LinkedListInterface where(WhereClause<T> list) {
        LinkedListInterface<T> linkedList = new DoublyLinkedList<>();
